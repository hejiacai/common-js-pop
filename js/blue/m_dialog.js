...
;(function($, window, document, undefined) {
    ...
    function showLoading() {
        show_Loading = $(document).dialog({
            type : 'toast',
            infoIcon: '//assets.huibo.com/img/blue/mcompany/loading.gif',
            infoText: '加载中',
        });
    }
