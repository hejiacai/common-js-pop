...
;!function (a, b) {
    ...
    var c, d, e = {
        ...
        v: "2.4", ie6: !!a.ActiveXObject && !a.XMLHttpRequest, index: 0, path: e.getPath, config: function (a, b) {
            var d = 0;
            return a = a || {}, f.cache = e.config = c.extend(e.config, a), f.path = e.config.path || f.path, "string" == typeof a.extend && (a.extend = [a.extend]), f.use("skin/layer.css?v=201609191", a.extend && a.extend.length > 0 ? function g() {
                var c = a.extend;
        ...
        if (b.config.is_iframeAuto) {
            setTimeout(function () {
                f.iframeAuto(b.index, b.config);
            }, 800);
        }
    };
    g.pt = g.prototype;
    ...
    }, f.iframeAuto = function (a, config) {
        if (a) {
            var offset = config ? config.offset : {};
            var d = c("#" + h[0] + a);
            // f.getChildFrame("html", a).css('height', 'auto');
            var b = f.getChildFrame("html", a).outerHeight() || d.find('.' + h[5]).outerHeight(),
                d_old = d.outerHeight() || 0,
                e = d.find(h[1]).outerHeight() || 0,
                b_1 = d.find('.' + h[5]).outerHeight() || 0,
                g = d.find("." + h[6]).outerHeight() || 0;
            g = parseInt(g);
            var body = document.documentElement.clientHeight;
            var hei = b < body - e - g - 30 ? b : body - e - g - 30;
            if (typeof offset == 'object' &&offset[0]) {
                d.css({
                    height: hei + e + g ? hei + e + g : "auto",
                    top: offset[0] ? offset[0] : (body - (hei + e + g)) * 0.6 < 0 ? 0 : (body - (hei + e + g)) * 0.6
                });
                d.find("iframe").css({
                    height: hei ? hei : "auto",
                    top: offset[0] ? offset[0] : (body - (hei)) * 0.6 < 0 ? 0 : (body - (hei)) * 0.6
                });
            } else {
                d.css({
                    height: hei + e + g ? hei + e + g : "auto",
                    top: (body - (hei + e + g)) * 0.6 < 0 ? 0 : (body - (hei + e + g)) * 0.6
                });
                d.find("iframe").css({
                    height: hei ? hei : "auto",
                    top: (body - (hei)) * 0.6 < 0 ? 0 : (body - (hei)) * 0.6
                });
            }
            // f.getChildFrame("html", a).css('height', '');
        }
