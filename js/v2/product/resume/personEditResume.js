...
define('product.resume.personEditResume',
...
function(require, exports, module) {
	...
	var personEditResume = shape(function(o){
			personEditResume.parent().call(this, util.merge({
				element: $('#baseinfor'),
				trigger: '.edit',
				formName: 'form',
