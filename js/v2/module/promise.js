...
define('module.promise', function(require, exports, module){
			...
			try {
				...
				if(newValue && (typeof newValue === "object" || typeof newValue === "function")) {
					...
					if(typeof then === "function"){
						...
						doResolve(util.bind(then, newValue), resolve, reject);
						return;
					}
				}
				state = true;
	...
	Promise.resolve = function(value) {
		...
		if(typeof value === "object" || typeof value === "function") {
			try {
				var then = value.then;
				if(typeof then === "function"){
					return new Promise(util.bind(then, value));
				}
			} catch (ex) {
				return new Promise(function(resolve, reject){
					reject(ex);
	...
	Promise.race = function(values) {
		return new Promise(function(resolve, reject){
			util.array.filter(values, function(value){
				// 将数组元素转换为promise对象
