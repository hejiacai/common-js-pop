...
define('mobile.mobileSortable.mobileMultiplePopup', 
...
function(require, exports, module){
	...
	var mobileMultiplePopup = shape(function(o){
		mobileMultiplePopup.parent().call(this, util.merge({
			maxLength: 1,
			popup: {
				title: '意向职位',
				yesBtn: false,
