...
define('highcharts.highstock', function(require, exports, module){
...
function numberFormat(number, decimals, decPoint, thousandsSep) {
	var externalFn = Highcharts2.numberFormat,
...
(function ($) {
	 ...
	 */
	win.HighchartsAdapter2 = win.HighchartsAdapter2 || ($ && {
			...
			$.fn.highcharts2 = function () {
				...
				if (this[0]) {
					...
					if (options !== UNDEFINED) {
						...
						chart = new Highcharts2[constr](options, args[1]);
						ret = this;
						/*jslint unused:true*/
					}
...
var globalAdapter = win.HighchartsAdapter2,
...
Highcharts2.VMLElement = VMLElement = extendClass(SVGElement, VMLElement);
...
Highcharts2.VMLRenderer = VMLRenderer = function () {
	this.init.apply(this, arguments);
};
...
if (useCanVG) {
	 ...
	 */
	Highcharts2.CanVGRenderer = CanVGRenderer = function () {
 ...
 * @param {Object} options
 */
Highcharts2.PlotLineOrBand = function (axis, options) {
	this.axis = axis;
...
Highcharts2.PlotLineOrBand.prototype = {
...
AxisPlotLineOrBandExtension = {
	...
	addPlotBandOrLine: function (options, coll) {
		var obj = new Highcharts2.PlotLineOrBand(this, options).render(),
				...
				each(tickPositions, function (pos, i) {
					if (i % 2 === 0 && pos < axis.max) {
						if (!alternateBands[pos]) {
							alternateBands[pos] = new Highcharts2.PlotLineOrBand(axis);
						}
 ...
 */
var Tooltip = Highcharts2.Tooltip = function () {
	this.init.apply(this, arguments);
};
 ...
 */
var Pointer = Highcharts2.Pointer = function (chart, options) {
...
Pointer.prototype = {
	...
	init: function (chart, options) {
		...
		if (Highcharts2.Tooltip && options.tooltip.enabled) {
...
extend(Highcharts2.Pointer.prototype, {
 ...
 */
var Legend = Highcharts2.Legend = function (chart, options) {
	this.init(chart, options);
};
...
var LegendSymbolMixin = Highcharts2.LegendSymbolMixin = {
...
var CenteredSeriesMixin = Highcharts2.CenteredSeriesMixin = {
	/**
...
var TrackerMixin = Highcharts2.TrackerMixin = {
...
if (Renderer === Highcharts2.VMLRenderer) {
...
Highcharts2.RangeSelector = RangeSelector;
 ...
 */
Highcharts2.StockChart = function (options, callback) {
