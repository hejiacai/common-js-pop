...
function(require, exports, module) {
    ...
    (function(e) {
        function t() {
            var e = location.href; 
            var hashtag = e.indexOf("#prettyPhoto") !== -1 ? decodeURI(e.substring(e.indexOf("#prettyPhoto") + 1, e.length)) : '';
        ...
        e.fn.prettyPhoto = function(s) {
            ...
            if (!pp_alreadyInitialized && t()) {
                ...
                setTimeout(function() {
					...
					try{
						var obj = e("a[" + s.hook + "^='" + hashRel + "']:eq(" + hashIndex + ")");
						if(e.length){
							obj.trigger("click");
						}
					}catch(e){}
