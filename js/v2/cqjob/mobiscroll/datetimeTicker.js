 ...
 *
 */
define('cqjob.mobiscroll.datetimeTicker', function(require, exports, module){
    ...
    function Scroller(elem, settings) {
        ...
        function read() {
			console.log(elm.val());
			console.log(s.defaultValue, s.parseValue(elm.val() || s.defaultValue || '', that));
            console.log(s.defaultValue);
            
            that.temp = ((input && that.val !== null && that.val != elm.val()) || that.values === null) ? s.parseValue(elm.val() || s.defaultValue || '', that) : that.values.slice(0);
            that.setValue(true);
        }
        ...
        */
        that.show = function (prevAnim) {
            ...
            // Create wheels containers
             var html = '',
			 	 btnHTML = (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb">' + s.cancelText + '</span></span></div>' : '<div class="dwcc"></div>');
				 
			 html += '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + btnHTML + (s.headerText ? '<div class="dwv"></div>' : ''));
        ...
        that.init = function (ss) {
            ...
            if (s.display == 'inline') {
                ...
                if (input && s.showOnFocus) {
                    ...
                    e.readOnly = true;
                    // Init show datewheel
                    elm.bind('focus.dw', function () { timeidx && clearTimeout(timeidx);timeidx = setTimeout(function(){that.show();}, 50); });
                }
            }
        };
